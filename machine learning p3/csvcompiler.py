...
input_directory = 'C:\\Users\\Jakeeer\\git\\senior_project\\machine learning p3\\database_filtered' 
#input_directory = 'C:\\Users\\Jakeeer\\git\\senior_project\\machine learning p2\\test_database' #to compile to the test csv 
# Define the output CSV filename
output_filename = "C:\\Users\\Jakeeer\\git\\senior_project\\machine learning p3\\emg_compiled.csv"
...
def read_data_from_csv(files):
    ...
    for file in files:
        ...
        with open(file, 'r') as f:
            reader = csv.reader(f)
            # Read the single column of values
