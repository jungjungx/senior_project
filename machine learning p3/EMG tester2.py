...
df = pd.read_csv("C:\\Users\\Jakeeer\\git\\senior_project\\machine learning p3\\emg_compiled_test.csv")
...
model.load_state_dict(torch.load('C:\\Users\\Jakeeer\\git\\senior_project\\machine learning p3\\EMG_trained.pth'))  #CHANGE
